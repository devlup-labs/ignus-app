package org.ignus.app.ui.registered_events
...
import org.ignus.app.db.viewmodels.RegisteredEventsViewModel
import org.ignus.app.ui.adapter.EventListAdapter
...
class SoloFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.soloEvents.observe(this, Observer {
            val category =
                EventCategory(0, "Registered Solo Events", "Registered Solo Events", "", it, "")
